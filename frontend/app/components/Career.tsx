        ...
        <div className="relative border-l-2 border-[#e8d0d0] ml-6 md:ml-12 pl-8 pb-8">
          ...
          <div className="mb-12 relative">
            ...
            <p className="text-gray-700">
              Ms.Engineerプログラミングスクールを卒業後、エンジニアとしての第一歩を踏み出すべく転職活動中です。
              バックエンドエンジニアを志望し、特にPythonを活用したサーバーサイド開発に興味を持っています。
            </p>
          </div>
          ...
          <div className="mb-12 relative">
            ...
            <p className="text-gray-700">
              ...
              Flowに基づくブランチ戦略を導入し、CI/CD環境の構築を担当。
            </p>
          </div>
          ...
          <div className="mb-12 relative">
            ...
            <p className="text-gray-700">
              クリエイト薬局にて調剤事務として勤務。処方箋の受付・入力、患者様対応、薬品在庫管理、後輩教育などを担当。
