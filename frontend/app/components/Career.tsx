        ...
        <div className="relative border-l-2 border-[#e8d0d0] ml-6 md:ml-12 pl-8 pb-8">
          ...
          <div className="mb-12 relative">
            ...
            <p className="text-gray-700">
              Ms.Engineerプログラミングスクールを卒業後、4月に調剤事務の仕事に復職しながら、
              エンジニアとしてのキャリアをスタートさせるべく転職活動を行っています。
              スクールで習得したフロントエンド・バックエンド両方のスキルを活かせる環境を探しており、
              特定の分野にこだわらず、まずはエンジニアとして実務経験を積むことを目指しています。
              現在は基本情報技術者試験の取得に向けて勉強中です。
              仕事と子育ての両立をしながらの活動ですが、限られた時間の中で効率的に学習を進め、エンジニアとしての基礎知識を固めています。
            </p>
          </div>
