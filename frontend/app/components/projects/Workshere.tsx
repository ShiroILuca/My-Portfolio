        ...
        <div className="mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700">
                チーム内で育休復職者が直面する課題について議論し、実際のニーズに基づいた機能の優先順位付けと仕様決定を行いました。私自身も育休中であったため、同じ立場のユーザーとして実際に感じている不安や、これから直面するであろう課題を考えながら、本当に必要な機能として設計することができました。
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="bg-[#f8f0f0] p-8 rounded-lg shadow-md border-l-4 border-[#e8d0d0]">
            ...
            <div className="text-gray-700 space-y-4">
              ...
              <p>
                また、3人でのチーム開発においてチーム内で意見の相違や不和を感じた時には、自分が2人の架け橋となって、それぞれの意見や立場を理解し、円滑なコミュニケーションを促進しました。お互いの考えを聞き合い、共通の理解を深めることで、チームの一体感を取り戻し、プロジェクトを前進させることができました。この経験を通じて、技術力だけでなく、チームの雰囲気づくりや調整力も開発において重要な要素であることを学びました。
              </p>
            </div>
          </div>
        </div>
