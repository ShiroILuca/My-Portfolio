    ...
    <section id="projects" className="min-h-screen p-8 md:p-16 bg-white">
      ...
      <div className="max-w-4xl mx-auto mb-12 bg-gray-50 p-6 rounded-lg border-l-4 border-gray-700 shadow-md">
        ...
        <p className="text-gray-600 mb-3">
          ...
          私が大切にしているのは、役割分担があってもチーム全員で一つのプロジェクトを成功させるという気持ちで取り組むことです。
        </p>
        <p className="text-gray-600">
          チーム開発では、お互いの進捗状況や取り組むタスクを定期的に共有し、つまづいている部分もオープンに共有することで、みんなで一緒に乗り越えてきました。
          また、チームメンバーの状況や環境に合わせて柔軟に対応し、必要な時はサポートに回ったり、メンバーを待つ間は他のタスクに着手したりと、時間を無駄にせず効率的な開発を心がけてきました。
        </p>
        <p className="text-gray-600">
          このような経験から、技術だけではなく「お互いを支え合う関係性」がより良いソフトウェアを生み出すことを実感しています。
        </p>
      </div>
